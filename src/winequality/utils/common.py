...
def load_json(path: Path) -> ConfigBox:
    ...
    logger.info(f"json file loaded succesfully from: {path}")  # log the loading of the file
    return ConfigBox(content)     # return the content as ConfigBox type, which allows access to attributes like a class
